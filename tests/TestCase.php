...
use Offspring\Permission\PermissionServiceProvider;

abstract class TestCase extends Orchestra
{
    /** @var \Offspring\Permission\Test\User */
    protected $testUser;

    /** @var \Offspring\Permission\Test\Admin */
    protected $testAdmin;

    /** @var \Offspring\Permission\Models\Role */
    protected $testUserRole;

    /** @var \Offspring\Permission\Models\Role */
    protected $testAdminRole;

    /** @var \Offspring\Permission\Models\Permission */
    ...
    protected function getEnvironmentSetUp($app)
    {
        ...
        $app['config']->set('cache.prefix', 'offspring_tests---');
    }
